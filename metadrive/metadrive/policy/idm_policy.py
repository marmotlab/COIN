...
class IDMPolicy(BasePolicy):
    ...
    MAX_STEERING_ANGLE = np.pi / 3  # [rad]  60du gail
    DELTA_SPEED = 5  # [m/s]

    DISTANCE_WANTED = 10.0
    """Desired jam distance to the front vehicle."""

    TIME_WANTED = 2.0  # 1.5[s]
    ...
    def __init__(self, control_object, random_seed):
        ...
        self.heading_pid = PIDController(1.7, 0.01, 3.5)   # (1.7, 0.01, 3.5)
        self.lateral_pid = PIDController(0.5, .002, 0.05)  # (0.3, .002, 0.05)
