...
from td3_ablationv1 import AblationV1
from td3_ablationv2 import AblationV2
from td3_ablationv3 import AblationV3
...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default="AblationV1", help='Policy name (TD3)')
    ...
    kwargs = {
        ...
        "policy_noise": float(args.policy_noise) * max_action,
        "noise_clip": args.noise_clip * max_action,
        "policy_freq": args.policy_freq,
        "hidden_dim": args.hidden_size,
        "weight_fac": args.weight_fac,
        "max_agents": max_num_agents,
    }
    # Initialize policy
    if args.policy == "AblationV1":
        policy = AblationV1(**kwargs)
    elif args.policy == "AblationV2":
        policy = AblationV2(**kwargs)
    elif args.policy == "AblationV3":
        policy = AblationV3(**kwargs)
    else:
